...
def main(_):
  ...
  for file in os.listdir(annotation_dir):
      ...
      classes = conv_names_to_ids(create_tf_example(ET.parse(annotation_path + filename).getroot()))
      for num in classes:
          if(num == 1):
              bottles+=1
          elif(num == 2):
  ...
  print("cardboards:" + str(cardboards))
  print("cups:" + str(cups))
  print("scraps:" + str(scraps))
