...
#IMG Path
PATH_TO_INPUT = "C:\\Users\\micha\\OneDrive\\Documents\\GitHub\\CVML-GSET-Project\\ensemble\\averager\\video\\input.mp4"
PATH_TO_OUTPUT = "C:\\Users\\micha\\OneDrive\\Documents\\GitHub\\CVML-GSET-Project\\ensemble\\averager\\video\\output.avi"
...
def write_prediction(image, prediction):
    ...
    with tf.Session(graph=graph1) as sess1:
        ...
        with tf.Session(graph=graph2) as sess2:
            ...
            while(ret == True):
                ...
                write_prediction(image, final_prediction)
